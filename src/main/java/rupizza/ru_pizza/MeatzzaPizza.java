...
/**
 * Meatzza pizza class representing a pizza with sausage, pepperoni, beef, ham toppings, and tomato sauce.
 */
public class MeatzzaPizza extends Pizza {

    /**
     * Constructs a MeatzzaPizza object with the specified size, extra sauce, and extra cheese options.
     *
    ...
    public MeatzzaPizza(Size size, boolean extraSauce, boolean extraCheese) {
        this.size = size;
        this.toppings = new ArrayList<>(List.of(Topping.SAUSAGE, Topping.PEPPERONI, Topping.BEEF, Topping.HAM));
    ...
    /**
     * Calculates the price of the Meatzza pizza based on its size, selected options, and toppings.
     *
