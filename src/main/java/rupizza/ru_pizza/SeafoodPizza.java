...
/**
 * Seafood pizza class representing a pizza with shrimp, squid, crab meats toppings, and alfredo sauce.
 */
public class SeafoodPizza extends Pizza {

    /**
     * Constructs a SeafoodPizza object with the specified size, extra sauce, and extra cheese options.
     *
    ...
    public SeafoodPizza(Size size, boolean extraSauce, boolean extraCheese) {
        this.size = size;
        this.toppings = new ArrayList<>(List.of(Topping.SHRIMP, Topping.SQUID, Topping.CRAB_MEAT));
    ...
    /**
     * Calculates the price of the Seafood pizza based on its size, selected options, and toppings.
     *
